...
const DOC_TYPE_STYLE: Record<string, string> = {
  "Correspondence": "bg-blue-500/10 text-blue-600 border-blue-200",
  "Floor plan":     "bg-violet-500/10 text-violet-600 border-violet-200",
  "Proposal":       "bg-amber-500/10 text-amber-600 border-amber-200",
  "LOI":            "bg-orange-500/10 text-orange-600 border-orange-200",
  "Legal":          "bg-primary/10 text-primary border-primary/20",
  "Executed":       "bg-success/10 text-success border-success/20",
  "Market data":    "bg-teal-500/10 text-teal-600 border-teal-200",
  "Due diligence":  "bg-rose-500/10 text-rose-600 border-rose-200",
}
