    ...
    return (
      <div ref={ref} className={cn(
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <Button variant="outline" size="sm" className="shrink-0 text-primary border-primary bg-transparent hover:bg-primary/10 hover:text-primary dark:bg-sidebar-accent dark:border-sidebar-border dark:text-sidebar-foreground dark:hover:bg-sidebar-accent/80">View deal pipeline</Button>
        </div>
